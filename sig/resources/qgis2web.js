...
map.getView().fit([-6292294.819577, -117272.433074, -5156652.464623, 467773.573395], map.getSize());
    ...
    element: (() => {
        ...
        if (318 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'GEOSEMIN é uma ferramenta de gestão e planejamento para o setor mineral no Amapá. Ele reúne informações geoespaciais sobre áreas de mineração, tipos de minerais, concessões e restrições ambientais, permitindo uma visão integrada e atualizável que facilita a tomada de decisões e o desenvolvimento sustentável do setor.';
            }
